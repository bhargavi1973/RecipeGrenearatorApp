...
const SavedRecipesPage: React.FC<SavedRecipesPageProps> = ({ recipes, onSelectRecipe, onDeleteRecipe, onGoBack }) => {
    ...
    <main className="flex-grow container mx-auto p-4 md:p-8 animate-fade-in">
        <div className="max-w-4xl mx-auto">
            <div className="flex items-center mb-8">
                ...
                <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100">{t('saved.title')}</h1>
            </div>
             ...
             {recipes.length > 0 ? (
                        ...
                        <div className="p-4 flex flex-col flex-grow">
                             ...
                             <div className="flex items-center justify-between mt-4">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <button
                                        onClick={() => onDeleteRecipe(recipe.recipeName)}
                                        className="text-gray-500 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-400 transition-colors"
                                        aria-label={`${t('common.delete')} ${recipe.recipeName}`}
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className="text-center text-gray-500 dark:text-gray-400 py-16 border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-lg">
                    <p className="text-lg">{t('saved.emptyTitle')}</p>
                    <p>{t('saved.emptySubtitle')}</p>
                </div>
                )}
        </div>
    </main>
